...
# exibir quantidade de letras
# pedir letra ao usuario
# analisar se a palavra contem a letra
# se sim -> revelar local da letra na palavra
# se nao -> diminuir numeros de tentativas
# se tentativas = 0, fim de jogo
# se palavra completa, acresentar pontos
# se inserir 0 pode digitar a palavra completa e ganhar mais pontos
# se tentativas != 0, limpar tela e atualizar jogo